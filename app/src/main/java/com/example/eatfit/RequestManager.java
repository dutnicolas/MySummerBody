...
import com.example.eatfit.Listeners.RandomRecipeResponseListener;
...
public class RequestManager {
    ...
    public void getRandomRecipes(RandomRecipeResponseListener listener,List<String> tags){
        ...
        Call<RandomRecipeApiResponse> call = callRandomRecipes.callRandomRecipe("a3e5cfb574634415a328623f1da8f2d7","10",tags);
